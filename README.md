...
<table>
  <tr>
    ...
    <td align="center" width="96"><img src="https://skillicons.dev/icons?i=godot" width="48" height="48" alt="Godot"/><br>Godot</td>
  ...
  <tr>
    ...
    <td align="center" width="96"><img src="https://skillicons.dev/icons?i=raspberrypi" width="48" height="48" alt="Raspberry Pi"/><br>Pi</td>
    <td align="center" width="96"><img src="https://skillicons.dev/icons?i=arch" width="48" height="48" alt="Arch Linux"/><br>Arch</td>
  </tr>
</table>
...
- **Home Assistant Server** — dedicated Pi 4 running HAOS, Zigbee smart home (SONOFF dongle + Philips Hue), in a self-designed 3D-printed 10" rack
- **Home Dashboard** — self-hosted, FastAPI + SQLite + WebSockets, served via Caddy in Docker
- **Photo Culling App** — FastAPI + vanilla JS + SQLite tool for sorting photography keepers, keyboard-driven workflow
- **Multiplayer Tag Game** — 3D tag game in Godot 4 (GDScript), host-authoritative netcode via ENetMultiplayerPeer
- **Print Progress Display** — ESP32 e-paper display showing live 3D printer progress from Home Assistant

 
---
 
<p align="center">
  <img src = "https://streak-stats.demolab.com?user=imnuclr&theme=tokyonight-duo&timezone=UTC&dates=EB545400" />
</p>

---
 
<p align="center">💬 Find me as <b>imnuclr</b> most places</p>
